...
require (
	...
	forge.lthn.ai/core/gui/pkg/docs v0.0.0-00010101000000-000000000000 // indirect
	forge.lthn.ai/core/gui/pkg/help v0.0.0-00010101000000-000000000000 // indirect
